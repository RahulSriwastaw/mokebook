...
import { ZoomIn, ZoomOut, Maximize2, Pause, Settings, ArrowLeft, ArrowRight, Triangle } from "lucide-react";
        ...
        <div className="h-screen flex flex-col bg-white" style={{ ...cssVariables }}>
            ...
            <header className="bg-[#1976D2] text-white shrink-0">
                <div className="flex items-center justify-between px-4 h-10">
                    <div className="flex items-center gap-3">
                        ...
                        <div className="text-[11px] opacity-80">{testName}</div>
                    </div>
            ...
            <div className="flex items-center justify-center gap-2 py-1.5 border-b bg-white shrink-0">
                <button
                    ...
                    className={cn(
                        "px-3 py-1 rounded text-[11px] font-bold text-white shadow-sm transition-all",
                        isMarked ? "bg-purple-600" : "bg-[#3B82F6] hover:bg-blue-700"
                    )}
                >
                    Mark for Review
                </button>
                <button
                    onClick={onSaveNext}
                    className="px-3 py-1 rounded text-[11px] font-bold text-white bg-[#3B82F6] hover:bg-blue-700 shadow-sm transition-all"
                >
                    Save & Next
                </button>
                <button
            ...
            <div className="flex-1 flex overflow-hidden">
                {/* Question Area */}
                <div className="flex-1 overflow-y-auto p-4" style={{ fontSize: `${zoomLevel}%` }}>
                    {question && (
